...
# The 5:5 Pedagogical Framework (Milk & Coffee)

Use this skill whenever authoring, editing, or auditing lesson content across Physics, Chemistry, Biology, and Mathematics.

## 1. The Core Ratio
A lesson for a seventh-grader must never be purely academic fluff, nor should it be a wall of dry symbols. It must balance two equal forces:
...
Never dumb down the syllabus:
- Write step-by-step KaTeX derivations showing every single algebraic transition.
- Never write "it can be shown that" or skip algebraic cancellations.
- Provide multi-tier worked problems with collapsible drawers and explicit unit tracking.

## 2. Lexicon Invariants
